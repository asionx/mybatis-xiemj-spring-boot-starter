...
public class DefaultResult<T> implements Result<T>, Serializable {
    ...
    @Override
    public Result<T> setViolationItems(List<ViolationItem> violationItems) {
        this.violationItems = violationItems;
        return this;
    }

    @Override
    public Result<T> setErrorClass(String errorClass) {
        this.errorClass = errorClass;
        return this;
    }

    @Override
    public Result<T> setErrorStack(String errorStack) {
